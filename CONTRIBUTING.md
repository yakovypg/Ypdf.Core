...
When contributing to this project, please first discuss the change you wish to make via [Discussions](https://github.com/yakovypg/Ypdf.Core/discussions) or [Issues](https://github.com/yakovypg/Ypdf.Core/issues) with the project owners. In addition, please follow code of conduct in all your interactions with the project.
...
## Discussions
If you do not understand something and need clarification, you can always ask us via [Discussions](https://github.com/yakovypg/Ypdf.Core/discussions) or [Issues](https://github.com/yakovypg/Ypdf.Core/issues). Before you ask a question, it is best to read available [documantation](DOCUMENTATION.md) and search for existing [Discussions](https://github.com/yakovypg/Ypdf.Core/discussions) and [Issues](https://github.com/yakovypg/Ypdf.Core/issues) that might help you.
...
## Issues
We use [Issues](https://github.com/yakovypg/Ypdf.Core/issues) to track public bugs and errors. Before you make an Issue, make sure your description of the problem is clear and provides sufficient instructions to reproduce the problem. Then follow these steps:
1. Open an Issue.
